...
def s3_update():
    files_lst = [
        'raw_data_fetch_time.pkl', 'qwi_us.csv', 'qwi_state.csv', 'qwi_msa.csv', 
        'qwi_county.csv', 'pep_us.csv', 'pep_state.csv', 'pep_msa.csv', 
        'pep_county.csv', 'earnbeg_us.csv'
    ]
    ...
    for file in files_lst:
        file_to_s3(
            ...
            'emkf.data.research', 
            f'indicators/eji/raw_data/{file}'
        )
